        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <form method="post" action="{{route('update_company_admin')}}">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>Surname</label>
                                <input class="form-control" type="text" name="surname" value="{{$admin->surname}}" placeholder="Enter surname" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="number" name="phonenumber" value="{{$admin->phonenumber}}" placeholder="Enter phonenumber" required>
                            </div>
                        </div>


                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary">Update Company Admin</button>
                        </div>
                    </form>
